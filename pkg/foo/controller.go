...
import (
	"context"
	v1 "github.com/rancher/operator-controller/pkg/apis/some.api.group/v1"
	foocontroller "github.com/rancher/operator-controller/pkg/generated/controllers/some.api.group/v1"
)
